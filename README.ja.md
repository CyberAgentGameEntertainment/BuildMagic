...
* [BuildMagic](#buildmagic)
  ...
  * [Quick Start](#quick-start)
    ...
    * [Pre-build コンフィギュレーションの適用](#pre-build-コンフィギュレーションの適用)
    * [Editor起動時にPre-buildコンフィギュレーションを適用](#editor起動時にpre-buildコンフィギュレーションを適用)
    * [UI上からのビルド](#ui上からのビルド)
...
### Pre-build コンフィギュレーションの適用

Pre-build コンフィギュレーションをを現在のUnityプロジェクトの設定に適用するには、左ペインのビルドスキームを右クリックし、「Apply Pre-build Now」を選択します。

![](./Documentation~/configure-build-scheme-switch.png)

### Editor起動時にPre-buildコンフィギュレーションを適用

Editor起動時にPre-buildコンフィギュレーションを適用するには、左ペインのビルドスキームを右クリックし、「Set as Primary」を選択します。

![](./Documentation~/configure-build-scheme-primary.png)

### UI上からのビルド

アプリをビルドするには、左ペインのビルドスキームを右クリックし、「Build Player Now...」を選択します。
...
| オプション引数     | 説明                                     | 型           |
|:------------|:---------------------------------------|:------------|
| `-scheme`   | 適用するビルドスキームの名前を指定します。省略した場合はプライマリスキームが使用されます。| string      |
